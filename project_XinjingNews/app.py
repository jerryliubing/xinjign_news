...
def create(config):
    ...
    file_log_handler = RotatingFileHandler(config.BASE_DIR + "/logs/xinjing_news.log", maxBytes=1024 * 1024 * 100,
                                           backupCount=10)
    ...
    app.logger_xinjing_news = logging
    ...
    def handle404(e):
        return render_template("news/404.html")  # 默认路径起始是templates
